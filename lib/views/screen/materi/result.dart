...
class ResultScreen extends StatelessWidget {
  const ResultScreen({super.key, required this.score, required this.idSubMateri, required this.userId});
  final int score;
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        score > 2 ? Container() : RoundedButton(
                            ...
                            textColor: kDark,
                            press: () {
                              Get.off(() => ContentScreen(idSubmateri: idSubMateri, userId: userId,));
                            }
                        )
                      ],
                    ),
